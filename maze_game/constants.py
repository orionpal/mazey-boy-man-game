...
C_WALL      = (40,  80, 140)
C_FLOOR     = (20,  20,  35)
C_PLAYER    = (150, 255, 180)  # brightened from (80,220,120) -- playtesters lost track of it in large mazes, where shrinking cell size leaves only a few pixels of colour to spot
C_PLAYER_OUTLINE = (255, 255, 255)  # white halo ring around the player marker, so it pops against wall/floor/entity colours alike, even at a few px radius
