...
class Augment:
    ...
    # pellets; one that makes the run easier spawns fewer. Neutral (1.0) by
    # default; concrete augments override what actually applies. Combined
    # multiplicatively across every active augment (see
