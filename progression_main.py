...
progression_main.py
--------------------
Playtest entry point for the labyrinth progression mode: 100 mazes,
gradually increasing in size, each with its own time limit. Groups of 5
mazes stitch together seamlessly; a break-and-resume prompt follows each
group. Running out of time on any maze ends the run back at maze 1.
...
def sync_window_size(window: Window, run: LabyrinthRun) -> pygame.Surface:
    """Same in-place-resize approach as main.py -- see its docstring for why."""
